  ...
  return (
    <div className="relative flex items-center w-full">
      ...
      >
        ...
        {/* Circular Icon */}
        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#E8D6B6] flex items-center justify-center flex-shrink-0 shadow-inner z-10 transition-transform duration-300 group-hover:scale-105">
          ...
          <div className="flex-1 pr-2 overflow-hidden flex flex-col md:flex-row gap-4 transition-all duration-300">
            ...
            <div className="flex flex-col gap-3 min-w-0 md:min-w-[200px] flex-1">
              <div>
                ...
                <p className="text-[#E8D6B6] text-sm md:text-base font-medium">
                  {edu.field}
                </p>
              </div>
      ...
      {mounted && (
        <div className="hidden 2xl:flex relative z-10 w-full h-[1200px] mt-12 items-center justify-center overflow-visible">
          ...
          <div className="absolute left-[10%] xl:left-[15%] top-1/2 -translate-y-1/2 w-0 h-0">
            ...
            <div className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-[#E8D6B6] shadow-2xl flex flex-col items-center justify-center z-20 border-[8px] border-[#071A35]">
