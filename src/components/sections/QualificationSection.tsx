...
function QualificationCard({ edu, index }: { edu: Qualification; index: number }) {
  ...
  return (
    <div className="relative flex items-center w-full">
      <div 
        className="relative w-full bg-[#244B3A] rounded-l-[40px] rounded-r-2xl md:rounded-l-full md:rounded-r-md flex items-center p-3 md:p-2 md:pr-6 shadow-xl border border-white/10 group hover:border-white/20 transition-colors"
      >
        {/* Arrow Tip */}
        <div 
          className="absolute top-0 right-[-20px] w-[21px] h-full bg-[#244B3A]"
          style={{ clipPath: 'polygon(0 0, 0 100%, 100% 50%)' }}
        />
        
        {/* Circular Icon */}
        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#DFE8D9] flex items-center justify-center flex-shrink-0 shadow-inner z-10 transition-transform duration-300 group-hover:scale-105">
          <GraduationCap size={32} className="text-[#244B3A]" />
        </div>
          ...
          <div className="flex-1 pr-2 overflow-hidden flex flex-col md:flex-row gap-4 transition-all duration-300">
            ...
            <div className="flex flex-col gap-3 min-w-0 md:min-w-[200px] flex-1">
              <div>
                ...
                <p className="text-[#DFE8D9] text-sm md:text-base font-medium">
                  {edu.field}
                </p>
              </div>
        ...
        {/* Number Badge */}
        <div className="absolute -top-3 right-4 w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#2F4F4F] border-[2px] border-white flex items-center justify-center text-white text-sm md:text-base font-bold shadow-lg z-10">
      ...
      {mounted && (
        <div className="hidden 2xl:flex relative z-10 w-full h-[1200px] mt-12 items-center justify-center overflow-visible">
          ...
          <div className="absolute left-[10%] xl:left-[15%] top-1/2 -translate-y-1/2 w-0 h-0">
            ...
            <div className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-[#DFE8D9] shadow-2xl flex flex-col items-center justify-center z-20 border-[8px] border-[#244B3A]">
              
              <div className="relative z-10 flex flex-col items-center">
                <Globe size={48} className="text-[#244B3A] mb-4" />
                <h2 className="text-[#244B3A] font-black text-xl text-center px-8 uppercase tracking-widest leading-tight">
