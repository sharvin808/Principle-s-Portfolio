              ...
              <ScrollReveal key={index} delay={0.1} direction={isEven ? 'right' : 'left'}>
                <div className="flex w-full justify-center relative">
                  ...
                  <div className="relative w-full max-w-full md:max-w-3xl lg:max-w-5xl flex items-stretch">
                    ...
                    {/* White Content Pill */}
                    <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center bg-[#DFE8D9] border border-white/40 rounded-3xl md:rounded-full p-6 md:px-10 md:py-6 shadow-[0_15px_35px_rgba(0,0,0,0.2)] w-full">
