      ...
      {/* Main Content Layout */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 flex flex-col justify-between bg-beige-card border border-border/80 rounded-2xl p-6 shadow-xl overflow-hidden min-h-[400px] lg:min-h-[500px]">
            ...
            {/* Desktop Map Canvas */}
            <div className="relative w-full h-auto aspect-[640/374] flex items-center justify-center bg-[#FFFFF0] rounded-xl overflow-hidden border border-border/60 shadow-inner" style={{ aspectRatio: '640/374' }}>
