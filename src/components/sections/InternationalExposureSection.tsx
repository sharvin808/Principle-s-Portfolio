      ...
      {/* Main Content Layout */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 flex flex-col justify-between bg-beige-card border border-border/80 rounded-2xl p-6 shadow-xl overflow-hidden min-h-[400px] lg:min-h-[500px]">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-xl border transition-all duration-300 cursor-pointer ${
                      isActive
                        ...
                        : 'bg-[#e8ce9e] text-[#071A35] border-border hover:border-[#102A4A]/50 hover:bg-[#faf3e3]'
                    }`}
                  >
                    <img
                      src={getFlagUrl(code)}
            ...
            {/* Desktop Map Canvas */}
            <div className="relative w-full h-auto aspect-[640/374] flex items-center justify-center bg-[#e8ce9e] rounded-xl overflow-hidden border border-border/60 shadow-inner" style={{ aspectRatio: '640/374' }}>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3.5 py-1.5 rounded-lg border text-sm font-semibold transition-all duration-300 cursor-pointer ${
                      isActive
                        ...
                        : 'bg-[#e8ce9e] text-[#071A35] border-border hover:text-[#102A4A] hover:border-[#102A4A]/50 hover:bg-[#faf3e3]'
                    }`}
                  >
                    <img
                      src={getFlagUrl(code)}
