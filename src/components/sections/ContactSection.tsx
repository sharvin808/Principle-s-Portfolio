              ...
              <div className="flex flex-wrap gap-4">
                ...
                {contactMe.linkedin && (
                  <a
                    ...
                    className="flex items-center gap-2.5 px-5 py-3 rounded-xl border border-border bg-surface text-base font-semibold hover:border-gold hover:text-gold transition-colors duration-200"
                  >
                    <svg
